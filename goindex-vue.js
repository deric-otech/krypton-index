self.props = {
  ...
  // https://github.com/w0lfrm/krypton-index/tree/production/themes
...
(function () {
  ...
  async function onGet(request) {
    ...
    if (path.startsWith('/~_~_goindex/resources/')) {
      ...
      const r = await fetch(`https://raw.githubusercontent.com/w0lfrm/krypton-index/production/themes/material-vue-${self.props.ui}/${remain}`);
